...
public class DialogflowAPIScript : MonoBehaviour {
	...
	void Start () {
		...
		// StartCoroutine(GetAgent("ya29.c.Kl62B062q21p-udq2gFZuFrqtK4fpG9gK1RKABZ6KmP94rEW21oUvn6XczniqzAXyvbGgqGgi4RgGonJaD_na6BRmWP9Z5moBsQ3F0jqBASC4wF19zihCtQWpVUDozSa"));
		...
		StartCoroutine(PostRequest("https://dialogflow.googleapis.com/v2/projects/coffee-wnsicn/agent/sessions/1234:detectIntent",
                              ""));
	}
	...
	{
		UnityWebRequest www = UnityWebRequest.Get("https://dialogflow.googleapis.com/v2/projects/coffee-wnsicn/agent");
